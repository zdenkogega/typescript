...
function Required(target, propName) {
    var _a;
    registeredValidators[target.constructor.name] = __assign(__assign({}, registeredValidators[target.constructor.name]), (_a = {}, _a[propName] = ['required'] // More naive approach, overwrites existing validators
    , _a));
}
function PositiveNumber(target, propName) {
    var _a;
    registeredValidators[target.constructor.name] = __assign(__assign({}, registeredValidators[target.constructor.name]), (_a = {}, _a[propName] = ['positive'] // More naive approach, overwrites existing validators
    , _a));
}
...
courseForm.addEventListener('submit', function (event) {
    ...
    var price = +priceEl.value; // + converts into number
